...
class BahayaLainnya_model extends CI_Model {
   ...
   public function insert_data_notif($notif)
     {
       $data = array('message'=>$notif, 'message'=> 'Terdapat Informasi Kehamilan Lainnya Terbaru');
     ...
     {
       $data = array('message'=>$notifedit, 'message'=> 'Terdapat Informasi Kehamilan Lainnya Terbaru');
         $this->db->insert('tbl_notif', $data);    
         return ($this->db->affected_rows() > 0);
     }
