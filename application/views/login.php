                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?php echo site_url('Login/login_admin') ?>" method="post">
...
?>
                                       ...
                                       <input type="email" class="form-control form-control-user" name="username"
                                        ...
                                        <input type="submit"  class="btn btn-primary btn-user btn-block" name="login" onclick="myFunction()" value="Login">
