...
foreach($bahayaBerat as $BH) : ?>
    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h4 class="m-0 font-weight-bold text-primary"><?=$BH->judul ?></h4>
                        </div>
                        <div class="card-body">
						...
						<div class="tab-pane active" id="horizontal-form">
									...
									<label for="disabledinput" class="control-label"><?=$BH->keterangan ?></label>
									</div>
                ...
                <a class="btn btn-danger" data-toggle="modal" style="background-color:	#8B0000;" data-target="#modal-DeleteData<?php echo $BH->id ?>"> Delete </a>
                <div class="modal fade" id="modal-DeleteData<?php echo $BH->id ?>">
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal" action="<?= base_url('BahayaBerat/deleteData')?>" method="post">
                                              <div class="form-group">
                                                <label style = "position: relative; left: 20px;"><H5><b>Anda Yakin Akan Menghapus Akun Ini...?</H5></label>
                                                <input type="hidden" value="<?php echo $BH->id ?>" name="id">                         
