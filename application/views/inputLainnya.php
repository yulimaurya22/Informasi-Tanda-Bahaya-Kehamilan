<div id="wrapper">
	...
	<section class="forms">
  	   ...
  	   <center>    <h3>Tambah Informasi Kehamilan</h3> </center>

  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal"  name= "frmriwayat" action="<?= base_url('BahayaLainnya/tambahaksi')?>" method="POST">
						...
						<a href="<?= base_url('BahayaLainnya')?>"> <button type="button" class="btn btn-secondary btn-style mt-4">Cancel</button>
						</center>
